...
public class CPU extends Product{
    ...
    double frecuency, String cacheMemory, int tdp, String socket, int lithography, boolean hasIntegratedGraphics, double high, double width, double length, 
    double weight, boolean fragile) throws BuildException{
        ...
        if (resultFrecuency != 0) {
            message += "La frecuencia máxima no es correcta porque " + Checker.getErrorMessage(resultFrecuency, 8.0, 5.0);
        }
